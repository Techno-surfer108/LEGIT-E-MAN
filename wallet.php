...
$currency = 'pak';
                        ...
                        $balanceQuery = "SELECT * FROM accounts WHERE username = ' $uname_login'";
    ...
    <table class="table card-table table-vcenter text-nowrap datatable">
        ...
        <tbody>
            <?php
                ...
                $userData
                $getSenderwalletId = "SELECT * FROM wallets WHERE user_id = {$userData['username']}";
